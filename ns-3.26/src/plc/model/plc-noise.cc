...
{
// war schon alles auskommentiert...
...
{
	PLC_LOG_FUNCTION (this);
//	m_pulse_len = UniformRandomVariable (0, MAX_PULSE_NOISE_DURATION);
//	m_pulse_gap = UniformRandomVariable (0, MAX_PULSE_GAP_DURATION);
	...
	: PLC_NoiseSource (src_node, noisePsd, PLC_NoiseSource::IMPULSIVE)/*, m_noisePsd (noisePsd)*//*, m_pulse_len (pulse_len_gen), m_pulse_gap (pulse_gap_gen)*/
{
	...
	m_pulse_len = pulse_len_gen;
	m_pulse_gap = pulse_gap_gen;


//    m_pulse_len = CreateObject<UniformRandomVariable>();
//    m_pulse_len->SetAttribute("Min", DoubleValue(pulse_len_gen->GetMin()));
//    m_pulse_len->SetAttribute("Max", DoubleValue(pulse_len_gen->GetMax()));
//    m_pulse_gap = CreateObject<UniformRandomVariable>();
//    m_pulse_gap->SetAttribute("Min", DoubleValue(pulse_gap_gen->GetMin()));
//    m_pulse_gap->SetAttribute("Max", DoubleValue(pulse_gap_gen->GetMax()));
}
