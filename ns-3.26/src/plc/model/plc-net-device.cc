...
PLC_NetDevice::GetTypeId (void)
{
    ...
    .AddTraceSource ("MacTx",
                     ...
                     MakeTraceSourceAccessor (&PLC_NetDevice::m_macTxTrace),
    ...
    .AddTraceSource ("MacRx",
                      ...
                      MakeTraceSourceAccessor (&PLC_NetDevice::m_macRxTrace),
                      "ns3::Packet::TracedCallback")
	;
	return tid;
}
...
PLC_NetDevice::Receive (Ptr<Packet> packet, Mac48Address from, Mac48Address to)
{
    ...
    if(packet->GetUid() == lastPacketUid) {
//        std::cout << "Doppelte Pakete!!!!" << std::endl;
        lastPacketUid = packet->GetUid();
        return;
    }
